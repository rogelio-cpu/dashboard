                ...
                <table className="w-full text-left border-collapse">
                    <thead className="bg-slate-200/50 dark:bg-white/5">
                        <tr>
                            ...
                            <th className="px-6 py-3 text-xs font-semibold text-slate-500 uppercase tracking-wider">Entrée (ml/min)</th>
                            <th className="px-6 py-3 text-xs font-semibold text-slate-500 uppercase tracking-wider">Sortie (ml/min)</th>
                            <th className="px-6 py-3 text-xs font-semibold text-slate-500 uppercase tracking-wider">Perte (vol)</th>
                            <th className="px-6 py-3 text-xs font-semibold text-slate-500 uppercase tracking-wider">Statut</th>
                        </tr>
                    </thead>
                    <tbody className="divide-y divide-white/10">
                        {history.map((row, idx) => {
                            const lossFmt = formatVolume(row.loss);
                            return (
